...
export class CategoryService {
    constructor(private fileService: FileService,  @InjectModel(Category.name)
    private categoryModel: Model<Category>,) {}
    async create(dto: CreateCategoryDto, picture: Express.Multer.File): Promise<Category> {
    ...
    async update(params: FindOneParams, dto: CreateCategoryDto, picture: Express.Multer.File ): Promise<Category> {
        const id = params.id
    ...
    async getAll(limit?: number, skip?: number): Promise<TReturnItem<Category[]>> {
