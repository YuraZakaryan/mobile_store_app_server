import {Body, Controller, Get, HttpStatus, Post, Put, Req, UseGuards, UsePipes, ValidationPipe} from '@nestjs/common';
...
export class AuthController {
    ...
    @Put('token/refresh')
    updateRefreshToken(@Req() req: ReqUser, @Body() dto: {refresh_token: string}) {
        return this.authService.updateRefreshToken(req, dto)
    }
